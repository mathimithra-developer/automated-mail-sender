...
const orgEmailSettingsSchema = new Schema({
  organization: { type: Schema.Types.ObjectId, ref: 'Organization', required: true },
  provider:     { type: String, enum: ['smtp', 'zepto', 'ses', 'resend', 'postmark', 'sendgrid', 'mailgun'], default: 'ses' },
...
const segmentSchema = new Schema({
  ...
  groupsMatch:  { type: String, enum: ['all', 'any'], default: 'all' },
  conditions: [{
    _id:       false,
...
const campaignSchema = new Schema({
  ...
  fromEmail:    { type: String, required: [true, 'Sender email is required'] },
  replyTo:      { type: String },
